...
public class FlashCardDetailListsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarfc.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(FlashCardDetailListsActivity.this, TopicListsActivity.class);
    ...
    private void createFlashCardListUseRecyclerView() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(FlashCardDetailListsActivity.this);
        ...
        FlashCardDetailListsAdapter flashCardDataAdapter = new FlashCardDetailListsAdapter(listFCsWithId);
        //Set data adapter.
        ...
        flashCardRecyclerView.addOnItemTouchListener(new RecyclerTouchListener(this, flashCardRecyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                utilPlayAudio.playAudio(position, listFCsWithId, FlashCardDetailListsActivity.this);
            }

            @Override
            public void onLongClick(View view, int position) {
                //Toast.makeText(getApplicationContext(), "LONG PRESS Position FC at = " + position, Toast.LENGTH_LONG).show();
                utilPlayAudio.playAudioForLong(position, listFCsWithId, FlashCardDetailListsActivity.this);
            }
        }));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        //Toast.makeText(this, "This is DFFlashCard Quick Help", Toast.LENGTH_LONG).show();
